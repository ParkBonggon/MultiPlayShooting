...
// End Cross Module References
	...
	{
		P_GET_ENUM(EItemType,Z_Param_itmeType);
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->EventGetItem_Implementation(EItemType(Z_Param_itmeType));
		P_NATIVE_END;
	}
	...
	void IItemInterface::EventGetItem(EItemType itmeType)
	{
	...
	{
		static const UECodeGen_Private::FBytePropertyParams NewProp_itmeType_Underlying;
		static const UECodeGen_Private::FEnumPropertyParams NewProp_itmeType;
	...
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UFunction_UItemInterface_EventGetItem_Statics::NewProp_itmeType_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_UItemInterface_EventGetItem_Statics::NewProp_itmeType = { "itmeType", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(ItemInterface_eventEventGetItem_Parms, itmeType), Z_Construct_UEnum_ItemPlugin_EItemType, METADATA_PARAMS(nullptr, 0) }; // 1287472050
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UItemInterface_EventGetItem_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UItemInterface_EventGetItem_Statics::NewProp_itmeType_Underlying,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UItemInterface_EventGetItem_Statics::NewProp_itmeType,
	};
#if WITH_METADATA
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UItemInterface_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UItemInterface_EventGetItem, "EventGetItem" }, // 4010944542
	};
#if WITH_METADATA
	...
	void IItemInterface::Execute_EventGetItem(UObject* O, EItemType itmeType)
	{
		check(O != NULL);
		...
		if (Func)
		{
			Parms.itmeType=itmeType;
			O->ProcessEvent(Func, &Parms);
		}
		else if (auto I = (IItemInterface*)(O->GetNativeInterfaceAddress(UItemInterface::StaticClass())))
		{
			I->EventGetItem_Implementation(itmeType);
		}
	}
	struct Z_CompiledInDeferFile_FID_Work_MultiPlayShooting_ShootingGameCode_Content_ItemPlugin_HostProject_Plugins_ItemPlugin_Source_ItemPlugin_Public_ItemInterface_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Work_MultiPlayShooting_ShootingGameCode_Content_ItemPlugin_HostProject_Plugins_ItemPlugin_Source_ItemPlugin_Public_ItemInterface_h_Statics::EnumInfo[] = {
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Work_MultiPlayShooting_ShootingGameCode_Content_ItemPlugin_HostProject_Plugins_ItemPlugin_Source_ItemPlugin_Public_ItemInterface_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UItemInterface, UItemInterface::StaticClass, TEXT("UItemInterface"), &Z_Registration_Info_UClass_UItemInterface, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UItemInterface), 1216629363U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Work_MultiPlayShooting_ShootingGameCode_Content_ItemPlugin_HostProject_Plugins_ItemPlugin_Source_ItemPlugin_Public_ItemInterface_h_525140707(TEXT("/Script/ItemPlugin"),
		Z_CompiledInDeferFile_FID_Work_MultiPlayShooting_ShootingGameCode_Content_ItemPlugin_HostProject_Plugins_ItemPlugin_Source_ItemPlugin_Public_ItemInterface_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Work_MultiPlayShooting_ShootingGameCode_Content_ItemPlugin_HostProject_Plugins_ItemPlugin_Source_ItemPlugin_Public_ItemInterface_h_Statics::ClassInfo),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Work_MultiPlayShooting_ShootingGameCode_Content_ItemPlugin_HostProject_Plugins_ItemPlugin_Source_ItemPlugin_Public_ItemInterface_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Work_MultiPlayShooting_ShootingGameCode_Content_ItemPlugin_HostProject_Plugins_ItemPlugin_Source_ItemPlugin_Public_ItemInterface_h_Statics::EnumInfo));
